...
public class WriteEmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spnStoreInto = findViewById(R.id.email_store_into);
        ...
        LinearLayout bigLayout = findViewById(R.id.writeEmailLayout);
        LinearLayout storageLayout = findViewById(R.id.writeEmailStorage);
        ...
        LinearLayout back = findViewById(R.id.back_from_email);
        ...
        Button btnWriteEmail = findViewById(R.id.buttonWriteEmail);
        btnWriteEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText emailET = findViewById(R.id.emailAddressET);
                EditText subjetET = findViewById(R.id.emailSubjectET);
                EditText messageET = findViewById(R.id.emailMessageET);

                String emailStr = emailET.getText().toString().trim();
                String subjectStr = subjetET.getText().toString().trim();
                ...
                status = uFCoder.WriteNdefRecord_Email(storage, emailStr, subjectStr, messageStr);
