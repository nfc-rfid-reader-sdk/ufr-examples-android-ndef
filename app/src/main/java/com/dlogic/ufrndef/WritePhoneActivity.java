...
public class WritePhoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout bigLayout = findViewById(R.id.writePhoneLayout);
        LinearLayout storageLayout = findViewById(R.id.writePhoneStorage);
        ...
        LinearLayout back = findViewById(R.id.back_from_phone);

        Spinner spnStoreInto = findViewById(R.id.phone_store_into);
        ...
        Button btnWritePhone = findViewById(R.id.butoonWritePhone);
        btnWritePhone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText phoneET = findViewById(R.id.phoneWriteET);
                ...
                status = uFCoder.WriteNdefRecord_Phone(storage, phoneStr);
