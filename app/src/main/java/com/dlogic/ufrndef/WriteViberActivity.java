...
public class WriteViberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_viber);
        ...
        LinearLayout bigLayout = findViewById(R.id.writeViberLayout);
        LinearLayout storageLayout = findViewById(R.id.writeViberStorage);
        ...
        Spinner spnStoreInto = findViewById(R.id.viber_store_into);
        ...
        LinearLayout back = findViewById(R.id.back_from_viber);
        ...
        Button btnWriteViber = findViewById(R.id.buttonWriteViber);
        btnWriteViber.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText messageET = findViewById(R.id.viberMessageET);
                ...
                status = uFCoder.WriteNdefRecord_Viber(storage, messageStr);
