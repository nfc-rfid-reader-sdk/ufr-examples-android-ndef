...
public class WriteAddressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout bigLayout = findViewById(R.id.writingAddressLayout);
        LinearLayout storageLayout = findViewById(R.id.writeAddressStorage);
        ...
        LinearLayout back = findViewById(R.id.back_from_address);

        Spinner spnStoreInto = findViewById(R.id.address_store_into);
        ...
        Button btnWriteAddress = findViewById(R.id.buttonWriteAddress);
        btnWriteAddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText addressET = findViewById(R.id.writeAddressET);
                ...
                status = uFCoder.WriteNdefRecord_Address(storage, addressStr);
