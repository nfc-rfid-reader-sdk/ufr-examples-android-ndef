...
public class WriteApplicationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout bigLayout = findViewById(R.id.writeApplicationLayout);
        LinearLayout storageLayout = findViewById(R.id.writeApplicationStorage);
        ...
        Spinner spnStoreInto = findViewById(R.id.application_store_into);
        ...
        LinearLayout back = findViewById(R.id.back_from_application);
        ...
        Button btnWriteApplication = findViewById(R.id.buttonWriteApplication);
        btnWriteApplication.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText packageET = findViewById(R.id.packageNameET);

                String appStr = packageET.getText().toString().trim();

                int status = 0;

                uFCoder.erase_all_ndef_records((byte) 1);

                status = uFCoder.WriteNdefRecord_AndroidApp(storage, appStr);
