...
public class WriteSkypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_skype);
        ...
        LinearLayout bigLayout = findViewById(R.id.writeSkypeLayout);
        LinearLayout storageLayout = findViewById(R.id.writeSkypeStorage);
        ...
        LinearLayout back = findViewById(R.id.back_from_skype);

        Spinner spnStoreInto = findViewById(R.id.skype_store_into);
        ...
        Spinner spnSkypeOperation = findViewById(R.id.skypeOperationSpinner);
        ArrayAdapter<CharSequence> spnSkypeOperationModes = ArrayAdapter.createFromResource(getApplicationContext(),
                R.array.skype_operation,
                R.layout.dl_spinner_textview);
        spnSkypeOperation.setAdapter(spnSkypeOperationModes);
        spnSkypeOperation.setSelection(0);
        spnSkypeOperation.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
        ...
        Button btnWriteSkype = findViewById(R.id.buttonWriteSkype);
        btnWriteSkype.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText nameET = findViewById(R.id.skypeNameET);
                ...
                status = uFCoder.WriteNdefRecord_Skype(storage, nameStr, operation);
