...
public class WriteBitcoinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_bitcoin);
        ...
        LinearLayout bigLayout = findViewById(R.id.writeBitcoinLayout);
        LinearLayout storageLayout = findViewById(R.id.writeBitcoinStorage);

        if (device == 0) {
            storageLayout.setVisibility(View.GONE);
            ViewGroup.LayoutParams params = bigLayout.getLayoutParams();
            final float scale = getResources().getDisplayMetrics().density;
            params.height = (int) (280 * scale);
            bigLayout.setLayoutParams(params);
        } else {
            storageLayout.setVisibility(View.VISIBLE);
        }

        Spinner spnStoreInto = findViewById(R.id.bitcoint_store_into);
        ...
        LinearLayout back = findViewById(R.id.back_from_bitcoin);
        ...
        Button btnWriteBitcoin = findViewById(R.id.buttonWriteBitcoin);
        btnWriteBitcoin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText addressET = findViewById(R.id.bitcoinAddressET);
                EditText amountET = findViewById(R.id.bitcoinAmountET);
                EditText messageET = findViewById(R.id.bitcoinMessageET);
                ...
                status = uFCoder.WriteNdefRecord_Bitcoin(storage, addressStr, amountStr, messageStr);
