...
public class WriteWhatsappActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_whatsapp);
        ...
        LinearLayout bigLayout = findViewById(R.id.writeWhatsappLayout);
        LinearLayout storageLayout = findViewById(R.id.writeWhatsappStorage);
        ...
        Spinner spnStoreInto = findViewById(R.id.whatsapp_store_into);
        ...
        LinearLayout back = findViewById(R.id.back_from_whatsapp);
        ...
        Button btnWriteWhatsapp = findViewById(R.id.buttonWriteWhatsapp);
        btnWriteWhatsapp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText messageET = findViewById(R.id.whatsappMessageET);
                ...
                status = uFCoder.WriteNdefRecord_Whatsapp(storage, messageStr);
