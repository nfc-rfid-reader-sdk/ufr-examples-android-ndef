...
public class WriteStreetViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_street_view);
        ...
        Spinner spnStoreInto = findViewById(R.id.streetview_store_into);
        ...
        LinearLayout bigLayout = findViewById(R.id.writeStreetViewLayout);
        LinearLayout storageLayout = findViewById(R.id.writeStreetViewStorage);
        ...
        LinearLayout back = findViewById(R.id.back_from_streetview);
        ...
        Button btnWriteStreetView = findViewById(R.id.buttonWriteStreetView);
        btnWriteStreetView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText latET = findViewById(R.id.SWLatitudeET);
                EditText lonET = findViewById(R.id.SWLongitudeET);
                ...
                status = uFCoder.WriteNdefRecord_StreetView(storage, latitudeStr, longitudeStr);
