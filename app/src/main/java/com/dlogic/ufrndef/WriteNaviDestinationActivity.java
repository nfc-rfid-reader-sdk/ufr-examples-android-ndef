...
public class WriteNaviDestinationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_navi_destination);
        ...
        Spinner spnStoreInto = findViewById(R.id.navi_store_into);
        ...
        LinearLayout bigLayout = findViewById(R.id.writeNaviLayout);
        LinearLayout storageLayout = findViewById(R.id.writeNaviStorage);
        ...
        LinearLayout back = findViewById(R.id.back_from_navidestination);
        ...
        Button btnWriteNavi = findViewById(R.id.buttonWriteNavi);
        btnWriteNavi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                EditText naviET = findViewById(R.id.naviDestinationET);

                String destStr = naviET.getText().toString().trim();

                int status = 0;

                uFCoder.erase_all_ndef_records((byte) 1);

                status = uFCoder.WriteNdefRecord_NaviDestination(storage, destStr);
