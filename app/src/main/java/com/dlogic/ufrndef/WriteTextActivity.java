...
public class WriteTextActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ndefText = findViewById(R.id.writeNdefTextId);
        ...
        LinearLayout bigLayout = findViewById(R.id.textLayout);
        LinearLayout storageLayout = findViewById(R.id.textStorage);
        ...
        LinearLayout back = findViewById(R.id.back_from_text);
        ...
        Spinner spnStoreInto = findViewById(R.id.text_store_into);
        ...
        Button btnWriteText = findViewById(R.id.buttonWriteText);
        btnWriteText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String textStr = ndefText.getText().toString().trim();

                uFCoder.erase_all_ndef_records((byte) 1);

                status = uFCoder.WriteNdefRecord_Text(storage, textStr);
